...
def attack(char_name: str, char_class: str) -> str:
    if char_class == 'warrior':
        message = (f'{char_name} нанёс урон противнику равный '
                f'{5 + randint(3, 5)}')
    if char_class == 'mage':
        message =  (f'{char_name} нанёс урон противнику равный'
                f'{5 + randint(5, 10)}')
...
def defence(char_name: str, char_class: str) -> str:
    if char_class == 'warrior':
        message =  (f'{char_name} блокировал {10 + randint(5, 10)} урона')
    if char_class == 'mage':
        message =  (f'{char_name} блокировал {10 + randint(-2, 2)} урона')
    if char_class == 'healer':
        message =  (f'{char_name} блокировал {10 + randint(2, 5)} урона')
    return message
